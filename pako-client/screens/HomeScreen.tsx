...
const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  const handleReceivePackage = async () => {
    try {
      ...
      console.log('✅ Backend alerté du début du processus');
      
      // Naviguer vers le formulaire de commande
      navigation.navigate('MultiStepPackageRegistration' as any);
      
    } catch (error) {
      console.error('❌ Erreur lors du démarrage du processus:', error);
      // Naviguer quand même vers le formulaire même en cas d'erreur
      navigation.navigate('MultiStepPackageRegistration' as any);
    }
  };
